...
void buffer_to_motor_state(uint8_t id,struct Struct_CAN_Rx_Buffer *Rx_Buffer)
{
	switch(id)
	{
		case(1):
		{
			  motor_manage_object1.encoder =(uint16_t)Rx_Buffer->Data[0]<<8|Rx_Buffer->Data[1];
        motor_manage_object1.omega=(int16_t)Rx_Buffer->Data[2]<<8|Rx_Buffer->Data[3];
        motor_manage_object1.torque=(int16_t)Rx_Buffer->Data[4]<<8|Rx_Buffer->Data[5];
        motor_manage_object1.temperaure=Rx_Buffer->Data[6];
		}
		case(2):
		{
			  motor_manage_object2.encoder =(uint16_t)Rx_Buffer->Data[0]<<8|Rx_Buffer->Data[1];
        motor_manage_object2.omega=(int16_t)Rx_Buffer->Data[2]<<8|Rx_Buffer->Data[3];
        motor_manage_object2.torque=(int16_t)Rx_Buffer->Data[4]<<8|Rx_Buffer->Data[5];
        motor_manage_object2.temperaure=Rx_Buffer->Data[6];
		}
			case(3):
		{
			  motor_manage_object3.encoder =(uint16_t)Rx_Buffer->Data[0]<<8|Rx_Buffer->Data[1];
        motor_manage_object3.omega=(int16_t)Rx_Buffer->Data[2]<<8|Rx_Buffer->Data[3];
        motor_manage_object3.torque=(int16_t)Rx_Buffer->Data[4]<<8|Rx_Buffer->Data[5];
        motor_manage_object3.temperaure=Rx_Buffer->Data[6];
		}
			case(4):
		{
			  motor_manage_object4.encoder=(uint16_t)Rx_Buffer->Data[0]<<8|Rx_Buffer->Data[1];
        motor_manage_object4.omega=(int16_t)Rx_Buffer->Data[2]<<8|Rx_Buffer->Data[3];
        motor_manage_object4.torque=(int16_t)Rx_Buffer->Data[4]<<8|Rx_Buffer->Data[5];
        motor_manage_object4.temperaure=Rx_Buffer->Data[6];
		}
			case(5):
		{
			  motor_manage_object5.encoder=(uint16_t)Rx_Buffer->Data[0]<<8|Rx_Buffer->Data[1];
        motor_manage_object5.omega=(int16_t)Rx_Buffer->Data[2]<<8|Rx_Buffer->Data[3];
        motor_manage_object5.torque=(int16_t)Rx_Buffer->Data[4]<<8|Rx_Buffer->Data[5];
        motor_manage_object5.temperaure=Rx_Buffer->Data[6];
		}
			case(6):
		{
			  motor_manage_object6.encoder=(uint16_t)Rx_Buffer->Data[0]<<8|Rx_Buffer->Data[1];
        motor_manage_object6.omega=(int16_t)Rx_Buffer->Data[2]<<8|Rx_Buffer->Data[3];
        motor_manage_object6.torque=(int16_t)Rx_Buffer->Data[4]<<8|Rx_Buffer->Data[5];
        motor_manage_object6.temperaure=Rx_Buffer->Data[6];
		}
			case(7):
		{
			  motor_manage_object7.encoder=(uint16_t)Rx_Buffer->Data[0]<<8|Rx_Buffer->Data[1];
        motor_manage_object7.omega=(int16_t)Rx_Buffer->Data[2]<<8|Rx_Buffer->Data[3];
        motor_manage_object7.torque=(int16_t)Rx_Buffer->Data[4]<<8|Rx_Buffer->Data[5];
        motor_manage_object7.temperaure=Rx_Buffer->Data[6];
		}
		
				case(8):
		{
			  motor_manage_object8.encoder=(uint16_t)Rx_Buffer->Data[0]<<8|Rx_Buffer->Data[1];
        motor_manage_object8.omega=(int16_t)Rx_Buffer->Data[2]<<8|Rx_Buffer->Data[3];
